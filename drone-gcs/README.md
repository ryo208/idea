...
- **背景は北海道スペースポート(HOSPO・大樹町)の実空中写真**(出典: 国土地理院)。スケールバーで校正(2.75m/px、約3km四方)し、滑走路中心を原点に位置合わせ。月夜調にグレーディングした上で、滑走路灯・スレッショルド灯(緑/赤)・エプロン投光器・射点方面の照明・集落の灯りをリアルタイム合成し、Mode-7方式で地面に疑似3D投影。ホーム座標は大樹町(42.4964N, 143.4463E)
